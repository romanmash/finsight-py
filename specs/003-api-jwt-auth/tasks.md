...
- [ ] T009 Create `apps/api-service/tests/routes/conftest.py` with:
  ...
  in `apps/api-service/tests/routes/conftest.py`
...
**Checkpoint**: `uv run pytest apps/api-service/tests/routes/test_auth.py -k "login or me"` — all pass offline.
...
**Checkpoint**: `uv run pytest apps/api-service/tests/routes/test_auth.py -k "refresh or expired"` — all pass offline.
...
**Checkpoint**: `uv run pytest apps/api-service/tests/routes/test_auth.py -k "admin or role or service"` — all pass offline.
...
- [ ] T019 [P] [US4] Write `apps/api-service/tests/routes/test_health.py`:
  ...
  in `apps/api-service/tests/routes/test_health.py`

**Checkpoint**: `uv run pytest apps/api-service/tests/routes/test_health.py` — all pass offline.
